...
public final class GreetingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "Greenfield.GreetingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<Greenfield.GRPCService.HelloRequest,
      Greenfield.GRPCService.HelloResponse> getGreetingMethod;
  ...
  public static io.grpc.MethodDescriptor<Greenfield.GRPCService.HelloRequest,
      Greenfield.GRPCService.HelloResponse> getGreetingMethod() {
    io.grpc.MethodDescriptor<Greenfield.GRPCService.HelloRequest, Greenfield.GRPCService.HelloResponse> getGreetingMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<Greenfield.GRPCService.HelloRequest,
      Greenfield.GRPCService.HelloResponse> getStreamGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "streamGreeting",
      requestType = Greenfield.GRPCService.HelloRequest.class,
      responseType = Greenfield.GRPCService.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<Greenfield.GRPCService.HelloRequest,
      Greenfield.GRPCService.HelloResponse> getStreamGreetingMethod() {
    io.grpc.MethodDescriptor<Greenfield.GRPCService.HelloRequest, Greenfield.GRPCService.HelloResponse> getStreamGreetingMethod;
    if ((getStreamGreetingMethod = GreetingServiceGrpc.getStreamGreetingMethod) == null) {
      synchronized (GreetingServiceGrpc.class) {
        if ((getStreamGreetingMethod = GreetingServiceGrpc.getStreamGreetingMethod) == null) {
          GreetingServiceGrpc.getStreamGreetingMethod = getStreamGreetingMethod =
              io.grpc.MethodDescriptor.<Greenfield.GRPCService.HelloRequest, Greenfield.GRPCService.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "streamGreeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Greenfield.GRPCService.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Greenfield.GRPCService.HelloResponse.getDefaultInstance()))
              .setSchemaDescriptor(new GreetingServiceMethodDescriptorSupplier("streamGreeting"))
              .build();
        }
      }
    }
    return getStreamGreetingMethod;
  }
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greeting(Greenfield.GRPCService.HelloRequest request,
    ...
    /**
     */
    public void streamGreeting(Greenfield.GRPCService.HelloRequest request,
        io.grpc.stub.StreamObserver<Greenfield.GRPCService.HelloResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getStreamGreetingMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getStreamGreetingMethod(),
            asyncServerStreamingCall(
              new MethodHandlers<
                Greenfield.GRPCService.HelloRequest,
                Greenfield.GRPCService.HelloResponse>(
                  this, METHODID_STREAM_GREETING)))
          .build();
    }
  }
  ...
  public static final class GreetingServiceStub extends io.grpc.stub.AbstractStub<GreetingServiceStub> {
    ...
    public void streamGreeting(Greenfield.GRPCService.HelloRequest request,
        io.grpc.stub.StreamObserver<Greenfield.GRPCService.HelloResponse> responseObserver) {
      asyncServerStreamingCall(
          getChannel().newCall(getStreamGreetingMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public Greenfield.GRPCService.HelloResponse greeting(Greenfield.GRPCService.HelloRequest request) {
    ...
    /**
     */
    public java.util.Iterator<Greenfield.GRPCService.HelloResponse> streamGreeting(
        Greenfield.GRPCService.HelloRequest request) {
      return blockingServerStreamingCall(
          getChannel(), getStreamGreetingMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Greenfield.GRPCService.HelloResponse> greeting(
        Greenfield.GRPCService.HelloRequest request) {
  ...
  private static final int METHODID_STREAM_GREETING = 1;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((Greenfield.GRPCService.HelloRequest) request,
              (io.grpc.stub.StreamObserver<Greenfield.GRPCService.HelloResponse>) responseObserver);
          break;
        case METHODID_STREAM_GREETING:
          serviceImpl.streamGreeting((Greenfield.GRPCService.HelloRequest) request,
              (io.grpc.stub.StreamObserver<Greenfield.GRPCService.HelloResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (GreetingServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getStreamGreetingMethod())
              .build();
        }
      }
    }
